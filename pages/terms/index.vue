  ...
  <v-container fluid>
    <v-row>
      <v-col class="px-6" cols="9">
        ...
        <p>
          This Comet User Agreement ("Terms") applies to your access to and use
          of getcomet.net ("Comet," "we," or "us"). By accessing or using Comet,
          you agree to be bound by these Terms. If you do not agree to these
          Terms, you may not access or use Comet.
        </p>
        <p class="title">Age</p>
        <p>
        ...
        <p>
          ...
          Account and anything that happens related to Your Account. Your
          account security is Your responsibility and Comet is not liable for
          any Account security issues. We recommend that you use a strong
          password that is used only with Comet.
        </p>
        <p>
        ...
        <p>
          ...
          you have all rights, power, and authority necessary to grant the
        ...
        <p>
          ...
          grant Comet the following license to use that Content:
        </p>
        <p>
          When Your Content is created with or submitted to Comet, you grant us
          ...
          connection with Your Content in all media formats and channels now
          known or later developed. This license includes the right for us to
          make Your Content available for syndication, broadcast, distribution,
          or publication by other companies, organizations, or individuals who
        ...
        <p>
          Any ideas, suggestions, and feedback about Comet that you provide to
          us are entirely voluntary, and you agree that Comet may use such
          ideas, suggestions, and feedback without compensation or obligation to
          you.
        </p>
        <p>
        ...
        <p>
          Comet may contain links to third-party websites, products, or
          services, which may be posted by other users (“Third-Party Content”).
          Third-Party Content is not under our control, and we are not
        ...
        <ul>
          ...
          <li>
            Use Comet to violate applicable law or infringe any person or
          ...
          <li>
            Use Comet to harvest, collect, gather or assemble information or
            data regarding Comet or users of Comet except as permitted in these
            Terms or in a separate agreement with Comet;
          </li>
          <li>
            Use Comet in any manner that could interfere with, disrupt,
            negatively affect, or inhibit other users from fully enjoying Comet
            or that could damage, disable, overburden, or impair the functioning
            of Comet in any manner;
          </li>
          <li>
          ...
          <li>
            ...
            publicly available searchable indices of the materials subject to
        ...
        <p>
          ...
          appropriate circumstances, of users of Comet who are repeat
          infringers. If you believe that anything on Comet infringes a
          copyright that you own or control, you may send a direct message to
          Dan#7457 on
          <a href="https://discord.gg/NPCMGSm">Discord</a>.
        </p>
        <p>
        ...
        <p>
          ...
          indemnify, and hold Comet harmless, including costs and attorneys’
          fees, from any claim or demand made by any third party due to or
          arising out of (a) your use of Comet, (b) your violation of these
          Terms, (c) your violation of applicable laws or regulations, or (d)
          Your Content. We reserve the right to control the defense of any
        ...
        <p>
          ...
          to the revised Terms, you must stop accessing and using Comet before
          the changes become effective.
        </p>
        <p class="title">Miscellaneous</p>
        <p>
          These Terms constitute the entire agreement between you and us
          regarding your access to and use of Comet. Our failure to exercise or
          ...
          for any reason, held to be illegal, invalid or unenforceable, the rest
          of the Terms will remain in effect. You may not assign or transfer any
          of your rights or obligations under these Terms without our consent.

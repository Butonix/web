  ...
  <v-row>
    <v-col class="px-6" cols="9">
      ...
      <p>
        ...
        AND NON-INFRINGEMENT. COMET, ITS LICENSORS, AND ITS THIRD PARTY SERVICE
        PROVIDERS DO NOT WARRANT THAT THE SERVICES ARE ACCURATE, COMPLETE,
        RELIABLE, CURRENT, OR ERROR FREE. COMET DOES NOT CONTROL, ENDORSE, OR
        TAKE RESPONSIBILITY FOR ANY CONTENT AVAILABLE ON OR LINKED TO THE
        SERVICES OR THE ACTIONS OF ANY THIRD PARTY OR USER. WHILE COMET ATTEMPTS
        TO MAKE YOUR ACCESS TO AND USE OF OUR SERVICES SAFE, WE DO NOT REPRESENT
      ...
      <p>
        ...
        TO THESE TERMS OR THE SERVICES, INCLUDING THOSE ARISING FROM OR RELATING
        TO CONTENT MADE AVAILABLE ON THE SERVICES THAT IS ALLEGED TO BE
        ...
        COMET ENTITIES EXCEED THE GREATER OF ONE HUNDRED U.S. DOLLARS ($100) OR
        ANY AMOUNT YOU PAID COMET IN THE PREVIOUS SIX MONTHS FOR THE SERVICES
        GIVING RISE TO THE CLAIM. THE LIMITATIONS OF THIS SECTION WILL APPLY TO
        ANY THEORY OF LIABILITY, INCLUDING THOSE BASED ON WARRANTY, CONTRACT,
        STATUTE, TORT (INCLUDING NEGLIGENCE) OR OTHERWISE, AND EVEN IF COMET HAS
        BEEN ADVISED OF THE POSSIBILITY OF ANY SUCH DAMAGE, AND EVEN IF ANY
      ...
      <p>
        ...
        of or relating to these Terms or the Services will be governed by the
        laws of New Jersey, other than its conflict of laws rules; all disputes
      ...
      <p>
        ...
        or relating to these Terms or the Services will be governed by the laws
        of the United States of America without reference to conflict of laws.
        To the extent permitted by federal law, the laws of New Jersey (other
        than its conflict of law rules) will apply in the absence of applicable
        federal law. All disputes related to these Terms or the Services will be
        brought solely in the federal or state courts located in Morristown, New
        Jersey.
      </p>

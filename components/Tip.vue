  ...
  data() {
    return {
      tips: [
        ...
        'If a post has received submit comments since the last time you viewed the post, the number of submit comments will be next to the total comment count, and submit comments will be marked with "New"',
